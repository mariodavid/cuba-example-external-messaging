package de.diedavids.cuba.example.ceem;
...
public class CeemTestContainer extends TestContainer {

    public CeemTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "de/diedavids/cuba/example/ceem/app.properties",
    ...
    public static class Common extends CeemTestContainer {

        public static final CeemTestContainer.Common INSTANCE = new CeemTestContainer.Common();
